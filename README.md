...
Chosing **Y** for this option means your PS4 will have internet access and the Pi will not turning off you will also be able to access the webhost http://pppwn.local for future control of the Pi after a succsfull pwn run you will also NOT be asked  > blockquote Do you want the Pi to shutdown after pwn success     
